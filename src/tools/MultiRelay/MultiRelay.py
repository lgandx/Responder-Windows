...
Logs_Path = "./logs/"
Logs = logging
Logs.basicConfig(filemode="a",filename=Logs_Path+'SMBRelay-Session.txt',level=logging.INFO, format='%(asctime)s - %(message)s', datefmt='%m/%d/%Y %I:%M:%S %p')
